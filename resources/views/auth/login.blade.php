                            ...
                            <div class="text-center mt-4">
                                ...
                                <ul class="social-list list-inline mt-3">
                                    ...
                                    <li class="list-inline-item">
                                        <a href="{{ route('auth.redirect', 'github') }}" class="social-list-item border-info text-primary"><i class="mdi mdi-github-circle"></i></a>
                                    </li>
                                    <li class="list-inline-item">
                                        <a href="javascript: void(0);" class="social-list-item border-info text-primary"><i class="mdi mdi-gitlab"></i></a>
                                    </li>
                                    <li class="list-inline-item">
                                        <a href="javascript: void(0);" class="social-list-item border-info text-primary"><i class="mdi mdi-linkedin"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </form>
