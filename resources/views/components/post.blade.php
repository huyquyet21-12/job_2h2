<div class="col-md-6 col-lg-4">
    <div class="rotating-card-container manual-flip" style="height: 328.85px; margin-bottom: 10px;">
        <div class="card">
            <div class="front" style="min-height:328.75px;">
                <!-- @if($post->is_pinned) -->
                ...
                <div class="card-content">
                    ...
                    <p class="card-description">
                        {{ $post->getLocationAttribute() }}
                    </p>
                    
                    <div class="footer text-center" style="display:flex;align-items:center;justify-content: space-between;">
                        @isset($company)
                        <div class="author">
                            <a href="#pablo">
                        ...
                        @endisset
                        <div>
                            {{ $post->getSalaryAttribute() }}
                        </div>
                        <!-- <button type="button" name="button" class="btn btn-sm btn-success btn-fill btn-round btn-rotate" style="float:right;">
